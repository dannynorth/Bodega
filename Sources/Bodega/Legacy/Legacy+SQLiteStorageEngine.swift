...
extension Legacy {
    ...
    public actor SQLiteStorageEngine: StorageEngine {
        ...
        public func readKeysAndValues(keys: [Legacy.CacheKey]) async throws -> [(key: Legacy.CacheKey, value: Data)] {
            return self.readDataAndKeys(keys: keys).map { ($0, $1) }
        }
        ...
        public func readAllKeysAndValues() async throws -> [(key: Legacy.CacheKey, value: Data)] {
            return self.readAllDataAndKeys().map { ($0, $1) }
        }
...
public extension Legacy.SQLiteStorageEngine {
    ...
    static var `default`: Legacy.SQLiteStorageEngine {
    ...
    static func `default`(appendingPath pathComponent: String) -> Legacy.SQLiteStorageEngine {
        Legacy.SQLiteStorageEngine(directory: .defaultStorageDirectory(appendingPath: pathComponent))!
    }
}

private extension Legacy.SQLiteStorageEngine {
...
private extension Legacy.SQLiteStorageEngine.Expressions {
