...
@available(*, deprecated, message: "CacheKey has been deprecated. Individual StorageEngines now define their own kinds of keys")
public typealias CacheKey = Legacy.CacheKey
...
private extension Legacy.CacheKey {
